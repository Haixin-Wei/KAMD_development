...
&cntrl
   ...
   pseudoBD_cycles=250,
   refer_1_start=91, refer_1_end=1477,
   refer_2_start=1640, refer_2_end=3176,
   refer_3_start=3332, refer_3_end=4877,
   refer_4_start=5070, refer_4_end=6456,
   refer_5_start=6619, refer_5_end=8155,
   refer_6_start=8311, refer_6_end=9856,
   solvent_start=10156, solvent_end=128097
/
EOF
